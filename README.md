...
- **Battery history chart**: click a frame's battery badge in the Devices list for a chart of its level over time, with a day/month/year range picker — a longer-range companion to the Power tab's sparkline.
- **Authentication**:
